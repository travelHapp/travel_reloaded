  ...
  useEffect(() => {
    const fetchDetails = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:8000/api/destination/${id}`, { headers });
      ...
      {isLoading ? (
        ...
        <div className="show-container">
          <img
            ...
            src={`http://localhost:8000/${details.image}`} // Asegúrate de que esta ruta sea correcta
